...
urlpatterns = [
    ...
    path('company/<int:comp_id>/tmpdel/', views.comp_tmpdel, name="Comp_TmpDel"),
    path('company/<int:comp_id>/permdel/', views.comp_permdel, name="Comp_PermDel"),
    ...
    path('item/<int:item_id>/permdel/', views.item_permdel, name="Item_PermDel"),
    path('item/cate/', views.cate_list, name="Cate_Lsit"),
    path('item/cate/<cate_id>/delete/', views.cate_del, name="Cate_Del"),
    path('item/cate/<cate_id>/prmntdel/', views.cate_prmntdel, name="Cate_PrmntDel"),
    path('item/mfg/', views.mfg_list, name="MFG_Lsit"),
    path('item/mfg/<mfg_id>/delete/', views.mfg_del, name="MFG_Del"),
    path('item/mfg/<mfg_id>/prmntdel/', views.mfg_prmntdel, name="MFG_PrmntDel"),
    ...
    path('inquiry/<int:inqry_id>/del/', views.inquiry_del, name="Inquiry_Del"),
